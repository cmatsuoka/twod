...
$(TARGET): $(TARGET).cpp engine.o image.o color.o size.o position.o background.o test.o sprite.o
	$(CC) $(OPTS) $(CFLAGS) -o $(TARGET) $(TARGET).cpp engine.o image.o color.o size.o position.o background.o test.o sprite.o
